Create a blog article from the markdown in `docs/blogs/desk-booking-limitations.md`. The article should be in: `src/pages/blog/desk-booking-limitations/index.tsx`.
