Create a blog article from the markdown in `docs/blogs/introducing-desk-booking-analytics.md`. The article should be in: `src/pages/blog/introducing-desk-booking-analytics/index.tsx`.
