Create a blog article from the markdown in `docs/blogs/solve-hot-desking-problems.md`. The article should be in: `src/pages/blog/solve-hot-desking-problems/index.tsx`.
