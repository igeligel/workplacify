Create a blog article from the markdown in `docs/blogs/desk-booking-law-firms-privacy-productivity.md`. The article should be in: `src/pages/blog/desk-booking-law-firms-privacy-productivity/index.tsx`.
