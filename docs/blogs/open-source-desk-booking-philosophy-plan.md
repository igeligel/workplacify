Create a blog article from the markdown in `docs/blogs/open-source-desk-booking-philosophy.md`. The article should be in: `src/pages/blog/open-source-desk-booking-philosophy/index.tsx`.
